            ...
            <div className="container">
              ...
              <div className="kontakt__flex">
                <ul>
                  ...
                  <li>
                    <Phone size={30} color="#A82834"/> {decodeHtml(data.kontakt_tel)}
                  </li>
                  <li>
                    <Printer size={30} color="#A82834" /> {decodeHtml(data.kontakt_fax)}
                  </li>
                  <li>
                    <Mail size={30} color="#A82834" /> {decodeHtml(data.kontakt_email)}
                  </li>
                  <li>
                    <MapPin size={30} color="#A82834" /> {decodeHtml(data.kontakt_adresse)}
                  </li>
                </ul>
